...
* **Cenário:** Ao adicionar um produto no carrinho e em seguida acessar o carrinho, o site deve exibir o campo "Quantity" contendo o número de produtos que foram adicionados. O campo "Quantity" deve permitir edição para que o usuário adicione ou remova o número desejado de itens do seu carrinho, porém esse número nunca pode ser menor que 1.
...
* **Cenário:** Ao adicionar produtos ['Crane', 'Excavator', 'Bulldozer'] no carrinho do qual o preço é de locação por hora, um desconto de 15%  é adicionado automaticamente ao carrinho do usuário. O valor total apresentado deve ser a soma dos valores de todos os produtos considerando o desconto.
